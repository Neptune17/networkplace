...
event_queue = Queue()
    ...
    # "NB": {
    #     "dataplane": "./commands/run_data.sh switch\n",
    #     "setup": "./run_bfshell.sh -f commands/multicast_command && python ./NetBeacon/switch/setup.py\n",
    #     "controlplane": "cd NetBeacon/switch/control_plane/ && python3 controller.py\n",
    #     "log": "/root/bf-sde-9.2.0/NetBeacon/switch/control_plane/NB.log",
    # },
