...
class CarpetBombingExtractorGeneratedFilter: public AbstractFilter{
  public:
    CarpetBombingExtractorGeneratedFilter(std::map<uint64_t, uint32_t> payload_hash_count, std::map<T, uint32_t> flow_label, AbstractFlowIdentification<T>* flow_identification);
